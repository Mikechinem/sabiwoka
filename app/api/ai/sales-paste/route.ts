...
Extract sale information from natural language text or chat messages.
...
- amount_paid: How much was actually paid (number only). If fully paid use total_amount. If not paid at all use 0
...
- If a field cannot be found, use null`,
    ...
    return NextResponse.json({ success: true, sale: parsed });

  } catch (error: any) {
    console.error("Sales paste error:", error);
