...
import { Plus, ShoppingBag, Clock, X, Mic, Sparkles, PenLine } from "lucide-react";
...
export default function SalesPage() {
  ...
  return (
    <div className="max-w-md mx-auto px-4 pt-6 pb-28">
      ...
      <header className="relative mb-8 pt-4">
        ...
        <div className="relative z-10 flex items-center justify-between">
          ...
          <motion.button
            ...
            className="flex items-center gap-1.5 px-4 py-2.5 rounded-full text-white text-sm font-bold shadow-md"
     ...
     {/* Input Section - Shifted down for breathing space */}
          ...
          >
            ...
            >
              ...
              <motion.button
                ...
                disabled={!form.customer_name || !form.total_amount || saving}
                className="w-full h-12 rounded-full text-white font-bold text-sm mt-5 disabled:opacity-50"
                style={{ background: "#134e4a" }}
              >
      ...
      <div className="mt-2">
        ...
        {loading ? (
          ...
          <div className="text-center py-12 bg-white rounded-3xl border border-dashed border-gray-200">
            ...
            <p className="text-gray-400 text-sm">The shop is open! Record your first sale of the day. ✨</p>
          </div>
        ) : (
          <div className="space-y-3">
            {sales.map((sale) => {
                ...
                >
                  <div className="flex items-start justify-between mb-2">
                    ...
                    <div className="flex items-center gap-2 ml-2 shrink-0">
                      <span
                        className="flex items-center gap-1 text-[10px] uppercase font-black px-2 py-0.5 rounded-md"
                  ...
                  <div className="flex items-center justify-between text-sm mb-2">
                    ...
                    <div>
                      <p className="text-[10px] uppercase font-bold text-gray-400">Received</p>
                  ...
                  {sale.notes && (
                    <p className="text-xs text-gray-400 bg-gray-50 px-3 py-2 rounded-xl mb-2">
                      {sale.notes}
                    </p>
                  )}
